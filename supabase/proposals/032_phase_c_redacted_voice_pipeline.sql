-- Phase C (Dev Proposal): Redacted Student Voice Pipeline
-- Status: proposal only, not applied automatically in this repo change
-- Purpose:
--   1. store privacy-safe redacted snippets
--   2. expose teacher-safe RPC get_class_redacted_voice()
